...
class AboutPhotographer {
  ...
  createAboutPhotographer() {
    ...
    <div id="about-photographer-img-container" class="col-4 col-lg-6 d-md-flex flex-md-wrap justify-content-md-center justify-content-lg-between">
        ...
        <img id="about-photographer-img" src="../../assets/images/Photographers_ID_Photos/${this._photographer.portrait}" alt="${this._photographer.name}" class="rounded-circle order-md-1 order-lg-2" width="200px" height="200px">
    </div>
